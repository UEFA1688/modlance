          ...
          <div className="py-8 lg:pe-8">
            <div className="space-y-5 lg:space-y-8">
                ...
                <div className="flex justify-center">
                  <RegisterButton open={open} onClick={() => setOpen(!open)} applied={appliedJob?.existingApplication ?? false} isSuccess={isSuccess}/>
                </div>
                }
...
function RegisterButton({ open, onClick, applied, isSuccess }: RegisterButtonProps){
  ...
  return (
    ...
    <>
    <button
      onClick={sessionData ? onClick : () => signIn()}
      disabled={open}
